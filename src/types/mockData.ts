...
export const MOCK_CONTACTS: Lead[] = [
    ...
    activities: [
      {
        type: "call",
        date: "2026-01-20",
        subject: "Úvodná konzultácia",
        content: "Prebrali sme požiadavky na nový web.",
      },
      {
        type: "email",
        date: "2026-01-18",
        subject: "Cenová ponuka",
        content: "Odoslaná ponuka na schválenie.",
      },
    ],
  ...
  },
  {
    ...
    activities: [
      { type: "email", date: "2026-01-15", subject: "Otázka k platbám" },
    ],
