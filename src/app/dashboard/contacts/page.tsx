            ...
            <div className="flex-1 overflow-hidden px-8 pb-8">
                {errorMsg ? (
                    <div className="h-full flex flex-col items-center justify-center bg-red-50 border-2 border-red-100 rounded-[3rem] p-12 text-center shadow-2xl relative overflow-hidden">
                        ...
                        <button onClick={() => window.location.reload()} className="px-8 py-4 bg-gray-900 text-white rounded-2xl font-black uppercase italic tracking-widest hover:bg-black transition-all">Re-initialize Engine</button>
                    </div>
                ) : contacts.length === 0 ? (
