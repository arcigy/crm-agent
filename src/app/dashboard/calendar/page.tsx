...
function CalendarContent() {
  ...
  return (
    <div className="h-[calc(100vh-40px)] flex flex-col bg-white dark:bg-[#09090b] overflow-hidden shadow-2xl rounded-[3rem] border border-border dark:border-white/10 transition-colors duration-500">
      <CalendarHeader
