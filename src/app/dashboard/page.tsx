...
export default async function DashboardPage() {
  ...
  return (
    <div className="h-[calc(100vh-140px)] md:h-[calc(100vh-32px)] flex flex-col max-w-[1920px] mx-auto overflow-hidden gap-4 pb-2">
      <PaymentSuccessToast />
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-2 grid-rows-2 gap-4 pb-2">
