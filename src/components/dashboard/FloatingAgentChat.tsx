  ...
  return (
    <>
      ...
      <div className="fixed top-6 right-6 z-[2000] flex flex-col items-end gap-3">
        {/* Menu Window */}
        {isMenuOpen && (
          <div className="w-[85vw] md:w-[320px] bg-card/90 backdrop-blur-2xl border border-white/10 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.3)] flex flex-col overflow-hidden animate-in slide-in-from-top-5 fade-in duration-300 transform-origin-top-right">
        ...
        <button
            onClick={() => {
                ...
                if (isOpen) setIsOpen(false); // Close chat if menu opens
            }}
            className={`
