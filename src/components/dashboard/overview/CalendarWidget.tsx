  ...
  return (
    <div className="bg-card p-8 rounded-[2.5rem] border border-border shadow-sm flex flex-col h-full">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-xl font-black uppercase italic tracking-tighter">Túto týždeň</h3>
      ...
      <div className="flex-1 space-y-4 overflow-auto thin-scrollbar pr-2">
        {events.slice(0, 4).map((event, i) => (
          <div key={i} className="relative pl-4 border-l-4 border-indigo-500 py-1">
        ...
        {events.length === 0 && (
          <p className="text-center text-xs text-muted-foreground italic py-10">Žiadne udalosti</p>
        )}
      </div>
